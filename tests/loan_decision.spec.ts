...
test('positive loan decision with low risk and correct input data should return 200', async ({
  request,
}) => {
...
test('positive loan decision with medium risk and correct input data should return 200', async ({
  request,
}) => {
...
test('positive loan decision with high risk and correct input data should return 200', async ({
  request,
}) => {
...
test('negative loan decision with very high risk and correct input data should return 200', async ({
  request,
}) => {
