...
test ('get api key with correct username and password should receive 200 OK', async ({ request }) => {
...
test (' get order info and current time with correct headers and valid order id should receive 200', async ({ request }) => {
...
test ('GET order info and time receive 400 if header x-application-name is incorrect', async ({ request }) => {
...
test ('GET order info and time,receive 400 if header x-session-id is incorrect', async ({ request }) => {
...
test("GET order info and time- receive 400 if header 'x-application-name' is missing", async ({ request }) => {
...
test ('GET order info and time -receive 400 if header x-session-id is missing', async ({ request }) => {
...
test ('DELETE an order by id with correct id  and valid api_key should return 204', async ({ request }) => {
